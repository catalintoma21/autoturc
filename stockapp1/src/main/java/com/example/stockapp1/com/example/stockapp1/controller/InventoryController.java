...
public class InventoryController {
    ...
    public ResponseEntity<?> addManualStockEntry(@RequestBody AddManualStockRequest request) {
        try {
            stockService.addManualStockEntry(
                request.getPartName(),
                request.getCarModel(),
                request.getPrice(),
                request.getQuantity(),
            ...
            return ResponseEntity.ok("Piesa a fost adăugată manual în stoc.");
        } catch(Exception e) {
